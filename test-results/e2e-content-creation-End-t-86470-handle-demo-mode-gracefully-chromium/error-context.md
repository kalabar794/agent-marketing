...
- text: "AI Content Generation 0% 0 of 6 agents complete ETA: 3 min Started at 8:11:06 PM Current time 08:11 PM"
...
- text: Progress 3.8933333333333335%
- progressbar
- text: 📋
...
- text: Progress 7.775555555555555%
- progressbar
- text: ✍️
...
- text: "running Role: Market Analysis Status: running Progress 3.8933333333333335% 📋"
- heading "Content Strategist" [level=4]
- text: "pending Role: Strategy & Planning Status: pending 🎯"
- heading "SEO Optimizer" [level=4]
- text: "running Role: Search Optimization Status: running Progress 7.775555555555555% ✍️"
...
- text: Working
- paragraph: 3.8933333333333335%
- text: "Status: running Progress: 3.8933333333333335% 📋"
- heading "Content Strategist" [level=3]
...
- text: Working
- paragraph: 7.775555555555555%
- text: "Status: running Progress: 7.775555555555555% ✍️"
- heading "Content Writer" [level=3]
...
- text: Market Researcher 8:11:10 PM
- paragraph: Currently processing...
- text: SEO Optimizer 8:11:10 PM
- paragraph: Currently processing...
